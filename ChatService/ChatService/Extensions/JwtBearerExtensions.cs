...
namespace ChatService.Extensions
{
    ...
    {
        public static List<Claim> CreateClaims(this User user, List<string> roles)
        {
        ...
        //Method that writes data to the payload
        ...
        {
            //This value will be used to set the token's expiration date
